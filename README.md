...
## Dashboard Interaction:
  <a href="https://github.com/DoniaAl-badawi23/Sales-Performance-Dashboard-TATA-Group/blob/main/TaskSalesPerformanceTATACompany.pbix">View Dashboard</a>

## Process:
  - 1- Collecting a Data from Different Sources.
  - 2- Cleaning and Preprocessing Data in Excel & Power Query Editor in PowerBI.
...
1- Increase Sales in Low-Performing Months
 ...
 - Consider promotional offers, seasonal campaigns, or new product launches.
  
2- Diversify Customer Base 

 - Reduce reliance on a few high-value customers by targeting new markets and expanding outreach.
 
3- Strengthen Underperforming Regions 

 - Invest in marketing and partnerships in Spain, Belgium, and Japan to boost sales.
